...
> **หมายเหตุ:** เวอร์ชันปัจจุบันของแอปไม่มีหน้า Login/Google ใน UI แล้ว (เข้าใช้งานจากหน้าแรกโดยตรง) — เอกสารนี้เก็บไว้สำหรับกรณีนำ Google OAuth กลับมาใช้กับ backend แบบเดิม
...
1. เปิด http://localhost:5173/ (ถ้าเปิดใช้ Google ใน UI อีกครั้ง)
